...
--	  {description = "show weather", group = "widgets"}),
    ...
    -- rofi
       ...
       os.execute(string.format("albert show",
       'run', 'albert'))
       end,
       {description = "Albert Launcher", group = "launcher"}),
    --
...
awful.util.spawn_with_shell("xinput set-prop 13 'libinput Tapping Enabled' 1")
